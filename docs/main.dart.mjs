...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1259: x0 => x0.createRange(),
      _1260: (x0,x1) => x0.selectNode(x1),
      _1261: x0 => x0.getSelection(),
      _1262: x0 => x0.removeAllRanges(),
      _1263: (x0,x1) => x0.addRange(x1),
      _1264: (x0,x1) => x0.createElement(x1),
      _1265: (x0,x1) => x0.append(x1),
      _1266: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1267: (x0,x1) => x0.add(x1),
      ...
      _1273: (x0,x1) => x0.createElement(x1),
      _1279: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1287: (x0,x1) => x0.getItem(x1),
      _1288: (x0,x1) => x0.removeItem(x1),
      _1289: (x0,x1,x2) => x0.setItem(x1,x2),
      _1290: Date.now,
      _1292: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1293: s => {
      ...
      _1295: () => typeof dartUseDateNowForTicks !== "undefined",
      _1296: () => 1000 * performance.now(),
      _1297: () => Date.now(),
      _1298: () => {
      ...
      _1300: () => new WeakMap(),
      _1301: (map, o) => map.get(o),
      _1302: (map, o, v) => map.set(o, v),
      _1303: x0 => new WeakRef(x0),
      _1304: x0 => x0.deref(),
      _1310: () => globalThis.WeakRef,
      _1315: s => JSON.stringify(s),
      _1316: s => printToConsole(s),
      _1317: (o, p, r) => o.replaceAll(p, () => r),
      _1319: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1320: s => s.toUpperCase(),
      _1321: s => s.trim(),
      _1322: s => s.trimLeft(),
      _1323: s => s.trimRight(),
      _1324: (string, times) => string.repeat(times),
      _1325: Function.prototype.call.bind(String.prototype.indexOf),
      _1326: (s, p, i) => s.lastIndexOf(p, i),
      _1327: (string, token) => string.split(token),
      _1328: Object.is,
      _1329: (a, i) => a.push(i),
      _1333: a => a.pop(),
      ...
      _1338: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1339: a => a.length,
      _1341: (a, i) => a[i],
      _1342: (a, i, v) => a[i] = v,
      _1344: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1345: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      ...
      _1348: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1349: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1350: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1351: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1353: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1354: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1355: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1356: (t, s) => t.set(s),
      _1358: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1360: o => o.buffer,
      _1361: o => o.byteOffset,
      _1362: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1363: (b, o) => new DataView(b, o),
      _1364: (b, o, l) => new DataView(b, o, l),
      _1365: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1366: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1367: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1368: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1369: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1370: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1371: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1372: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1373: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1374: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1375: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1376: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1379: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1380: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1381: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1382: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1383: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1384: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1401: o => Object.keys(o),
      _1402: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1403: (handle) => clearTimeout(handle),
      _1404: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1405: (handle) => clearInterval(handle),
      _1406: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1407: () => Date.now(),
      _1413: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1414: (x0,x1,x2) => x0.fetch(x1,x2),
      _1415: (x0,x1) => x0.get(x1),
      _1416: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1416(f,arguments.length,x0,x1,x2) }),
      _1417: (x0,x1) => x0.forEach(x1),
      _1418: x0 => x0.abort(),
      _1419: () => new AbortController(),
      _1420: x0 => x0.getReader(),
      _1421: x0 => x0.read(),
      _1422: x0 => x0.cancel(),
      _1437: (x0,x1) => x0.key(x1),
      _1448: (s, m) => {
        try {
      ...
      _1449: (x0,x1) => x0.exec(x1),
      _1450: (x0,x1) => x0.test(x1),
      _1451: x0 => x0.pop(),
      _1453: o => o === undefined,
      _1455: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1457: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1458: o => o instanceof RegExp,
      _1459: (l, r) => l === r,
      _1460: o => o,
      _1461: o => o,
      _1462: o => o,
      ...
      _1464: o => o.length,
      _1466: (o, i) => o[i],
      _1467: f => f.dartFunction,
      _1468: () => ({}),
      _1469: () => [],
      _1471: () => globalThis,
      _1472: (constructor, args) => {
      ...
      _1474: (o, p) => o[p],
      _1475: (o, p, v) => o[p] = v,
      _1476: (o, m, a) => o[m].apply(o, a),
      _1478: o => String(o),
      _1479: (p, s, f) => p.then(s, f),
      _1480: o => {
      ...
      _1481: o => [o],
      _1482: (o0, o1) => [o0, o1],
      _1483: (o0, o1, o2) => [o0, o1, o2],
      _1484: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1498: x0 => x0.index,
      _1500: x0 => x0.flags,
      _1501: x0 => x0.multiline,
      _1502: x0 => x0.ignoreCase,
      _1503: x0 => x0.unicode,
      _1504: x0 => x0.dotAll,
      _1505: (x0,x1) => x0.lastIndex = x1,
      _1506: (o, p) => p in o,
      _1507: (o, p) => o[p],
      _1510: x0 => x0.random(),
      _1513: () => globalThis.Math,
      _1514: Function.prototype.call.bind(Number.prototype.toString),
      _1515: Function.prototype.call.bind(BigInt.prototype.toString),
      _1516: Function.prototype.call.bind(Number.prototype.toString),
      _1517: (d, digits) => d.toFixed(digits),
      _1521: () => globalThis.document,
      _1522: () => globalThis.window,
      _1527: (x0,x1) => x0.height = x1,
      _1529: (x0,x1) => x0.width = x1,
      _1532: x0 => x0.head,
      _1533: x0 => x0.classList,
      _1537: (x0,x1) => x0.innerText = x1,
      _1538: x0 => x0.style,
      _1540: x0 => x0.sheet,
      _1551: x0 => x0.offsetX,
      _1552: x0 => x0.offsetY,
      _1553: x0 => x0.button,
      _2931: (x0,x1) => x0.src = x1,
      _2933: (x0,x1) => x0.type = x1,
      _2939: (x0,x1) => x0.defer = x1,
      _3400: () => globalThis.window,
      _3442: x0 => x0.location,
      ...
      _4058: x0 => x0.length,
      _6000: x0 => x0.signal,
      _6074: () => globalThis.document,
      _6156: x0 => x0.body,
      _7835: x0 => x0.value,
      _7837: x0 => x0.done,
      _8539: x0 => x0.url,
      _8541: x0 => x0.status,
      _8543: x0 => x0.statusText,
      _8544: x0 => x0.headers,
      _8545: x0 => x0.body,
...
"supabase-dart/2.6.3",
"Initialize SupabaseClient v2.6.3 with no custom access token",
"InvalidJWTToken",
"apikey",
...
"functions",
"supabase.functions",
"functions-dart/2.4.1",
"Initialize FunctionsClient v",
"2.4.1",
"_isolate",
"postgrest-dart/2.4.1",
