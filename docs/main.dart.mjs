...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1195: x0 => x0.length,
      _1257: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1258: (x0,x1) => x0.append(x1),
      _1263: x0 => x0.createRange(),
      _1264: (x0,x1) => x0.selectNode(x1),
      _1265: x0 => x0.getSelection(),
      _1266: x0 => x0.removeAllRanges(),
      _1267: (x0,x1) => x0.addRange(x1),
      _1268: (x0,x1) => x0.createElement(x1),
      _1269: (x0,x1) => x0.append(x1),
      _1270: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1271: (x0,x1) => x0.add(x1),
      _1272: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1272(f,arguments.length,x0) }),
      _1273: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1275: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1276: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1277: (x0,x1) => x0.createElement(x1),
      _1283: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1291: (x0,x1) => x0.getItem(x1),
      _1292: (x0,x1) => x0.removeItem(x1),
      _1293: (x0,x1,x2) => x0.setItem(x1,x2),
      _1294: Date.now,
      _1296: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1297: s => {
      ...
      _1299: () => typeof dartUseDateNowForTicks !== "undefined",
      _1300: () => 1000 * performance.now(),
      _1301: () => Date.now(),
      _1302: () => {
      ...
      _1304: () => new WeakMap(),
      _1305: (map, o) => map.get(o),
      _1306: (map, o, v) => map.set(o, v),
      _1307: x0 => new WeakRef(x0),
      _1308: x0 => x0.deref(),
      _1314: () => globalThis.WeakRef,
      _1318: s => JSON.stringify(s),
      _1319: s => printToConsole(s),
      _1320: (o, p, r) => o.replaceAll(p, () => r),
      _1322: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1323: s => s.toUpperCase(),
      _1324: s => s.trim(),
      _1325: s => s.trimLeft(),
      _1326: s => s.trimRight(),
      _1327: (string, times) => string.repeat(times),
      _1328: Function.prototype.call.bind(String.prototype.indexOf),
      _1329: (s, p, i) => s.lastIndexOf(p, i),
      _1330: (string, token) => string.split(token),
      _1331: Object.is,
      _1332: (a, i) => a.push(i),
      _1336: a => a.pop(),
      _1337: (a, i) => a.splice(i, 1),
      _1338: (a, s) => a.join(s),
      _1339: (a, s, e) => a.slice(s, e),
      _1341: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1342: a => a.length,
      _1344: (a, i) => a[i],
      _1345: (a, i, v) => a[i] = v,
      _1347: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1348: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1349: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1350: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1351: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      ...
      _1354: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1356: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1357: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1358: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1359: (t, s) => t.set(s),
      _1361: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1363: o => o.buffer,
      _1364: o => o.byteOffset,
      _1365: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1366: (b, o) => new DataView(b, o),
      _1367: (b, o, l) => new DataView(b, o, l),
      _1368: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1369: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1370: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1371: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1372: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1373: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1374: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1375: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1376: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1377: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1378: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1379: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1382: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1383: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1384: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1385: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1386: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1387: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1404: o => Object.keys(o),
      _1405: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1406: (handle) => clearTimeout(handle),
      _1407: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1408: (handle) => clearInterval(handle),
      _1409: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1410: () => Date.now(),
      _1411: (x0,x1) => new WebSocket(x0,x1),
      _1412: (x0,x1) => x0.send(x1),
      _1413: (x0,x1,x2) => x0.close(x1,x2),
      _1414: (x0,x1) => x0.close(x1),
      _1415: x0 => x0.close(),
      _1416: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1417: (x0,x1) => globalThis.fetch(x0,x1),
      _1418: (x0,x1) => x0.get(x1),
      _1419: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1419(f,arguments.length,x0,x1,x2) }),
      _1420: (x0,x1) => x0.forEach(x1),
      _1421: x0 => x0.abort(),
      _1422: () => new AbortController(),
      _1423: x0 => x0.getReader(),
      _1424: x0 => x0.read(),
      _1425: x0 => x0.cancel(),
      _1426: x0 => new BroadcastChannel(x0),
      _1427: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1427(f,arguments.length,x0) }),
      _1428: (x0,x1) => x0.postMessage(x1),
      _1429: x0 => x0.close(),
      ...
      _1456: (x0,x1) => x0.exec(x1),
      _1457: (x0,x1) => x0.test(x1),
      _1458: x0 => x0.pop(),
      _1460: o => o === undefined,
      _1462: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1464: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1465: o => o instanceof RegExp,
      _1466: (l, r) => l === r,
      _1467: o => o,
      _1468: o => o,
      _1469: o => o,
      ...
      _1488: o => [o],
      _1489: (o0, o1) => [o0, o1],
      _1490: (o0, o1, o2) => [o0, o1, o2],
      _1491: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1505: x0 => x0.index,
      _1507: x0 => x0.flags,
      _1508: x0 => x0.multiline,
      _1509: x0 => x0.ignoreCase,
      _1510: x0 => x0.unicode,
      _1511: x0 => x0.dotAll,
      _1512: (x0,x1) => x0.lastIndex = x1,
      _1513: (o, p) => p in o,
      _1514: (o, p) => o[p],
      _1517: x0 => x0.random(),
      _1520: () => globalThis.Math,
      _1521: Function.prototype.call.bind(Number.prototype.toString),
      _1522: Function.prototype.call.bind(BigInt.prototype.toString),
      _1523: Function.prototype.call.bind(Number.prototype.toString),
      _1524: (d, digits) => d.toFixed(digits),
      _1528: () => globalThis.document,
      _1529: () => globalThis.window,
      _1534: (x0,x1) => x0.height = x1,
      _1536: (x0,x1) => x0.width = x1,
      _1539: x0 => x0.head,
      _1540: x0 => x0.classList,
      _1544: (x0,x1) => x0.innerText = x1,
      _1545: x0 => x0.style,
      _1547: x0 => x0.sheet,
      _1558: x0 => x0.offsetX,
      _1559: x0 => x0.offsetY,
      _1560: x0 => x0.button,
      _2938: (x0,x1) => x0.src = x1,
      _2940: (x0,x1) => x0.type = x1,
      _2946: (x0,x1) => x0.defer = x1,
      _3407: () => globalThis.window,
      _3450: x0 => x0.location,
      _3469: x0 => x0.navigator,
      _3733: x0 => x0.localStorage,
      _3741: x0 => x0.href,
      _3858: x0 => x0.userAgent,
      _3909: x0 => x0.data,
      _3956: (x0,x1) => x0.onmessage = x1,
      _4063: x0 => x0.length,
      _4280: x0 => x0.readyState,
      _4293: (x0,x1) => x0.binaryType = x1,
      _4296: x0 => x0.code,
      _4297: x0 => x0.reason,
      _6005: x0 => x0.signal,
      _6079: () => globalThis.document,
      _6161: x0 => x0.body,
      _7840: x0 => x0.value,
      _7842: x0 => x0.done,
      _8544: x0 => x0.url,
      _8546: x0 => x0.status,
      _8548: x0 => x0.statusText,
      _8549: x0 => x0.headers,
      _8550: x0 => x0.body,
...
"LV",
"ThemeMode.",
"https://www.antidopings.gov.lv/lv/pieklustamibas-pazinojums-zalu-parbaude",
"_heroController",
"iOS",
...
"externalApplication",
"LaunchMode.",
"Apstiprinu lietotnes lietošanas nosacījumus",
"material",
"_CheckboxType.",
...
"themeValue",
"widgetValue",
"Izvēlies medikamentu no saraksta",
"https://www.antidopings.gov.lv/lv/darbinieki?items_per_page=20&position[120]=120#content-area",
"spaceAround",
"Aizliegto vielu un metožu saraksta klase: ",
...
"active_substance",
"strength_lv",
"aizliegts_arpus_sacensibam",
"aizliegts_sacensibu_laika",
"aizliegto_vielu_un_metozu_saraksta_klase",
"piezimes_par_lietosanu",
"sporta_veidi_kuros_aizliegts_arpus_sacensibam",
"sporta_veidi_kuros_aizliegts_sacensibu_laika",
"_searchTerm",
"_searchMode",
"_ActivityIndicatorType.",
"Medikamentu references",
"_snapshot",
"client",
...
" was not ",
"found in the application assets. Ensure ",
".ttf exists in a ",
...
"Initialize Supabase v2.9.1",
"sb-",
"https://vmxtbdrsckctydwsfidg.supabase.co",
"-auth-token",
...
"Session from recovery is expired",
"Session expired.",
"TOKEN_REFRESHED",
"tokenRefreshed",
"INITIAL_SESSION",
...
"Saving session: ",
"Saving session",
"Don't call refresh token, already in progress",
...
"400",
"AuthSessionMissingException(message: ",
", statusCode: ",
"Attempt ",
" to refresh token",
"grant_type",
...
"ErrorCode.",
"AuthWeakPasswordException(message: ",
", reasons: ",
"msg",
"error_description",
"^2[0-9]{3}-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[0-1])",
"T00:00:00.0Z",
...
"Starting deeplink observer",
"Jw==",
"KA==",
"Error while receiving deeplink",
"handle deeplink uri: ",
"handle deeplink uri",
"Error while getSessionFromUrl",
"No access_token detected.",
"No expires_in detected.",
"No refresh_token detected.",
"No token_type detected.",
"No user found.",
"recovery",
"PASSWORD_RECOVERY",
"passwordRecovery",
...
"supabase.supabase",
"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZteHRiZHJzY2tjdHlkd3NmaWRnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTUzMzMwOTcsImV4cCI6MjAzMDkwOTA5N30.VAKvyk79WziNKkH2qPLSk8NzuSLWwSn3QOoPwvscS4s",
"https://vmxtbdrsckctydwsfidg.supabase.co/rest/v1",
"https://vmxtbdrsckctydwsfidg.supabase.co/realtime/v1",
"ws",
"https://vmxtbdrsckctydwsfidg.supabase.co/auth/v1",
"https://vmxtbdrsckctydwsfidg.supabase.co/storage/v1",
"https://vmxtbdrsckctydwsfidg.supabase.co/functions/v1",
"Initialize SupabaseClient v2.8.0 with no custom access token",
"InvalidJWTToken",
"apikey",
...
"supabase.storage",
"storage-dart/2.4.0",
"Initialize SupabaseStorageClient v",
"2.4.0",
" with url: ",
", retryAttempts: ",
"functions",
"supabase.functions",
"functions-dart/2.4.3",
"Initialize FunctionsClient v",
"2.4.3",
"_isolate",
"postgrest-dart/2.4.2",
"Initialize PostgrestClient with url: ",
", schema: ",
"Access token is expired and refreshing failed, aborting api request",
"Can't refresh session, no current session found.",
"Refresh session",
"supabase.auth",
"gotrue-dart/2.13.0",
"Initialize GoTrueClient v",
"2.13.0",
", autoRefreshToken: ",
", flowType: ",
", tickDuration: ",
