...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1527: x0 => x0.length,
      _1595: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      _1615: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1616: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1617: (x0,x1) => x0.createElement(x1),
      _1631: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1632: (x0,x1) => x0.getItem(x1),
      _1633: (x0,x1) => x0.removeItem(x1),
      _1634: (x0,x1,x2) => x0.setItem(x1,x2),
      _1648: x0 => new Array(x0),
      _1650: x0 => x0.length,
      _1652: (x0,x1) => x0[x1],
      _1653: (x0,x1,x2) => x0[x1] = x2,
      _1656: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1658: x0 => new Int8Array(x0),
      _1659: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1660: x0 => new Uint8Array(x0),
      _1668: x0 => new Int32Array(x0),
      _1670: x0 => new Uint32Array(x0),
      _1672: x0 => new Float32Array(x0),
      _1674: x0 => new Float64Array(x0),
      _1707: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1708: () => new TextDecoder("utf-8", {fatal: true}),
      _1709: () => new TextDecoder("utf-8", {fatal: false}),
      ...
      _1740: s => JSON.stringify(s),
      _1741: s => printToConsole(s),
      _1742: a => a.join(''),
      _1745: (s, t) => s.split(t),
      ...
      _1758: (a, i) => a.push(i),
      _1762: a => a.pop(),
      _1763: (a, i) => a.splice(i, 1),
      _1765: (a, s) => a.join(s),
      _1766: (a, s, e) => a.slice(s, e),
      _1768: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1769: a => a.length,
      _1771: (a, i) => a[i],
      _1772: (a, i, v) => a[i] = v,
      _1774: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1775: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1776: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1777: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1778: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1779: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1780: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1781: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1783: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1784: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1785: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1786: (t, s) => t.set(s),
      _1788: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1790: o => o.buffer,
      _1791: o => o.byteOffset,
      _1792: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1793: (b, o) => new DataView(b, o),
      _1794: (b, o, l) => new DataView(b, o, l),
      _1795: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1796: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1797: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1798: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1799: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1800: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1801: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1802: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1803: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1804: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1805: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1806: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1809: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1810: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1811: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1812: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1813: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1814: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1827: (o, t) => o instanceof t,
      ...
      _1831: o => Object.keys(o),
      _1832: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1833: (handle) => clearTimeout(handle),
      _1834: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1835: (handle) => clearInterval(handle),
      _1836: (c) =>
      ...
      _1994: (x0,x1) => x0.height = x1,
      _1996: (x0,x1) => x0.width = x1,
      _2000: x0 => x0.head,
      _2002: x0 => x0.classList,
      ...
      _2012: x0 => x0.offsetY,
      _2013: x0 => x0.button,
      _2086: (x0,x1) => x0.withCredentials = x1,
      _2088: x0 => x0.responseURL,
      _2089: x0 => x0.status,
      _2090: x0 => x0.statusText,
      _2092: (x0,x1) => x0.responseType = x1,
      _2093: x0 => x0.response,
      _3418: (x0,x1) => x0.src = x1,
      _3420: (x0,x1) => x0.type = x1,
      _3426: (x0,x1) => x0.defer = x1,
      _3905: () => globalThis.window,
      _3951: x0 => x0.location,
      _3970: x0 => x0.navigator,
      _4234: x0 => x0.localStorage,
      _4242: x0 => x0.href,
      _4361: x0 => x0.userAgent,
      _4581: x0 => x0.length,
      _6685: () => globalThis.document,
      _6778: x0 => x0.body,
