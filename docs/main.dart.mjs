...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1332: x0 => x0.createRange(),
      _1333: (x0,x1) => x0.selectNode(x1),
      _1334: x0 => x0.getSelection(),
      _1335: x0 => x0.removeAllRanges(),
      _1336: (x0,x1) => x0.addRange(x1),
      _1337: (x0,x1) => x0.createElement(x1),
      _1338: (x0,x1) => x0.append(x1),
      _1339: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1340: (x0,x1) => x0.add(x1),
      _1341: x0 => x0.preventDefault(),
      _1342: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1342(f,arguments.length,x0) }),
      _1343: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1566: (x0,x1) => new WebSocket(x0,x1),
      _1567: (x0,x1) => x0.send(x1),
      _1568: (x0,x1,x2) => x0.close(x1,x2),
      _1569: (x0,x1) => x0.close(x1),
      _1570: x0 => x0.close(),
      _1571: () => new AbortController(),
      _1572: x0 => x0.abort(),
      _1573: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1574: (x0,x1) => globalThis.fetch(x0,x1),
      _1575: (x0,x1) => x0.get(x1),
      _1576: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1576(f,arguments.length,x0,x1,x2) }),
      _1577: (x0,x1) => x0.forEach(x1),
      _1578: x0 => x0.getReader(),
      _1579: x0 => x0.cancel(),
      _1580: x0 => x0.read(),
      _1581: x0 => new BroadcastChannel(x0),
      _1582: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1582(f,arguments.length,x0) }),
      _1583: (x0,x1) => x0.postMessage(x1),
      _1584: x0 => x0.close(),
      _1585: (x0,x1) => x0.key(x1),
      _1586: x0 => x0.random(),
      ...
      _1608: () => globalThis.window,
      _1613: (x0,x1) => { x0.height = x1 },
      _1615: (x0,x1) => { x0.width = x1 },
      _1618: x0 => x0.head,
      _1619: x0 => x0.classList,
      _1623: (x0,x1) => { x0.innerText = x1 },
      _1624: x0 => x0.style,
      _1626: x0 => x0.sheet,
      _1637: x0 => x0.offsetX,
      _1638: x0 => x0.offsetY,
      _1639: x0 => x0.button,
      _3017: (x0,x1) => { x0.src = x1 },
      _3019: (x0,x1) => { x0.type = x1 },
      _3025: (x0,x1) => { x0.defer = x1 },
      _3486: () => globalThis.window,
      _3529: x0 => x0.location,
      _3548: x0 => x0.navigator,
      _3812: x0 => x0.localStorage,
      _3820: x0 => x0.href,
      _3937: x0 => x0.userAgent,
      _3988: x0 => x0.data,
      _4035: (x0,x1) => { x0.onmessage = x1 },
      _4142: x0 => x0.length,
      _4359: x0 => x0.readyState,
      _4372: (x0,x1) => { x0.binaryType = x1 },
      _4375: x0 => x0.code,
      _4376: x0 => x0.reason,
      _6084: x0 => x0.signal,
