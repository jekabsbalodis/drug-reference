...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1641: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1642: (x0,x1) => x0.getItem(x1),
      _1643: (x0,x1) => x0.removeItem(x1),
      _1644: (x0,x1,x2) => x0.setItem(x1,x2),
      ...
      _1750: s => JSON.stringify(s),
      _1751: s => printToConsole(s),
      _1752: a => a.join(''),
      _1755: (s, t) => s.split(t),
      _1756: s => s.toLowerCase(),
      _1757: s => s.toUpperCase(),
      _1758: s => s.trim(),
      _1759: s => s.trimLeft(),
      _1760: s => s.trimRight(),
      _1762: (s, p, i) => s.indexOf(p, i),
      _1763: (s, p, i) => s.lastIndexOf(p, i),
      _1765: Object.is,
      _1766: s => s.toUpperCase(),
      _1767: s => s.toLowerCase(),
      _1768: (a, i) => a.push(i),
      _1772: a => a.pop(),
      _1773: (a, i) => a.splice(i, 1),
      _1775: (a, s) => a.join(s),
      _1776: (a, s, e) => a.slice(s, e),
      _1778: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1779: a => a.length,
      _1781: (a, i) => a[i],
      _1782: (a, i, v) => a[i] = v,
      _1784: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1785: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1786: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1787: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1788: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1789: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1790: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1791: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1796: (t, s) => t.set(s),
      _1798: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1800: o => o.buffer,
      _1801: o => o.byteOffset,
      _1802: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1803: (b, o) => new DataView(b, o),
      _1804: (b, o, l) => new DataView(b, o, l),
      _1805: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1806: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1807: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1808: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1809: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1810: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1811: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1812: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1813: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1814: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1815: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1816: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1819: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1820: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1821: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1822: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1823: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1824: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1847: () => Date.now(),
      _1854: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1855: (x0,x1,x2) => x0.fetch(x1,x2),
      _1856: (x0,x1) => x0.get(x1),
      _1857: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1857(f,arguments.length,x0,x1,x2) }),
      _1858: (x0,x1) => x0.forEach(x1),
      _1859: x0 => x0.abort(),
      _1860: () => new AbortController(),
      _1861: x0 => x0.getReader(),
      _1862: x0 => x0.read(),
      _1863: x0 => x0.cancel(),
      _1880: (x0,x1) => x0.key(x1),
      _1896: (s, m) => {
        try {
      ...
      _1898: (x0,x1) => x0.test(x1),
      _1899: (x0,x1) => x0.exec(x1),
      _1900: (x0,x1) => x0.exec(x1),
      _1901: x0 => x0.pop(),
      _1903: o => o === undefined,
      _1922: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1924: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1925: o => o instanceof RegExp,
      _1926: (l, r) => l === r,
      _1927: o => o,
      _1928: o => o,
      _1929: o => o,
      ...
      _1931: o => o.length,
      _1934: (o, i) => o[i],
      _1935: f => f.dartFunction,
      _1936: l => arrayFromDartList(Int8Array, l),
      _1937: l => arrayFromDartList(Uint8Array, l),
      _1938: l => arrayFromDartList(Uint8ClampedArray, l),
      _1939: l => arrayFromDartList(Int16Array, l),
      _1940: l => arrayFromDartList(Uint16Array, l),
      _1941: l => arrayFromDartList(Int32Array, l),
      _1942: l => arrayFromDartList(Uint32Array, l),
      _1943: l => arrayFromDartList(Float32Array, l),
      _1944: l => arrayFromDartList(Float64Array, l),
      _1945: x0 => new ArrayBuffer(x0),
      _1946: (data, length) => {
      ...
      _1947: l => arrayFromDartList(Array, l),
      _1948: () => ({}),
      _1949: () => [],
      _1950: l => new Array(l),
      _1951: () => globalThis,
      ...
      _1974: x0 => x0.index,
      _1979: x0 => x0.flags,
      _1980: x0 => x0.multiline,
      _1981: x0 => x0.ignoreCase,
      _1982: x0 => x0.unicode,
      _1983: x0 => x0.dotAll,
      _1984: (x0,x1) => x0.lastIndex = x1,
      _1986: (o, p) => o[p],
      _1989: x0 => x0.random(),
      _1990: x0 => x0.random(),
      _1994: () => globalThis.Math,
      _1996: Function.prototype.call.bind(Number.prototype.toString),
      _1997: (d, digits) => d.toFixed(digits),
      _2001: () => globalThis.document,
      _2002: () => globalThis.window,
      _2007: (x0,x1) => x0.height = x1,
      _2009: (x0,x1) => x0.width = x1,
      _2013: x0 => x0.head,
      _2016: x0 => x0.classList,
      _2021: (x0,x1) => x0.innerText = x1,
      _2022: x0 => x0.style,
      _2024: x0 => x0.sheet,
      _2036: x0 => x0.offsetX,
      _2037: x0 => x0.offsetY,
      ...
      _3932: () => globalThis.window,
      _3977: x0 => x0.location,
      _3996: x0 => x0.navigator,
      _4260: x0 => x0.localStorage,
      _4268: x0 => x0.href,
      _4387: x0 => x0.userAgent,
      _4607: x0 => x0.length,
      _6632: x0 => x0.signal,
      _6711: () => globalThis.document,
      _6804: x0 => x0.body,
      _8536: x0 => x0.value,
      _8538: x0 => x0.done,
      _9261: x0 => x0.url,
      _9263: x0 => x0.status,
      _9265: x0 => x0.statusText,
      _9266: x0 => x0.headers,
      _9267: x0 => x0.body,
