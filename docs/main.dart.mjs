...
_1614: (x0,x1) => x0.removeItem(x1),
_1615: (x0,x1,x2) => x0.setItem(x1,x2),
_1619: (x0,x1) => x0.matchMedia(x1),
...
_1667: v => stringToDartString(v.toString()),
_1668: (d, digits) => stringToDartString(d.toFixed(digits)),
_1672: o => new WeakRef(o),
_1673: r => r.deref(),
_1678: Date.now,
...
_1691: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1692: s => printToConsole(stringFromDartString(s)),
...
_1711: () => Date.now(),
_1717: () => new XMLHttpRequest(),
_1718: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1719: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1720: (x0,x1) => x0.send(x1),
_1721: x0 => x0.abort(),
_1722: x0 => x0.getAllResponseHeaders(),
_1730: f => finalizeWrapper(f,x0 => dartInstance.exports._1730(f,x0)),
...
_1996: (x0,x1) => x0.withCredentials = x1,
_1999: x0 => x0.responseURL,
_2000: x0 => x0.status,
_2001: x0 => x0.statusText,
_2002: (x0,x1) => x0.responseType = x1,
_2004: x0 => x0.response,
_3761: () => globalThis.window,
_3821: x0 => x0.location,
_3841: x0 => x0.navigator,
_4099: x0 => x0.localStorage,
_4108: x0 => x0.href,
_4322: x0 => x0.userAgent,
_4540: x0 => x0.length
    };
