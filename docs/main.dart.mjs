...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1202: x0 => x0.length,
      _1265: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1266: (x0,x1) => x0.append(x1),
      _1271: x0 => x0.createRange(),
      _1272: (x0,x1) => x0.selectNode(x1),
      _1273: x0 => x0.getSelection(),
      _1274: x0 => x0.removeAllRanges(),
      _1275: (x0,x1) => x0.addRange(x1),
      _1276: (x0,x1) => x0.createElement(x1),
      _1277: (x0,x1) => x0.append(x1),
      _1278: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1279: (x0,x1) => x0.add(x1),
      _1280: x0 => x0.preventDefault(),
      _1281: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1281(f,arguments.length,x0) }),
      _1282: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1284: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1285: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1286: (x0,x1) => x0.createElement(x1),
      _1292: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1300: (x0,x1) => x0.getItem(x1),
      ...
      _1327: s => JSON.stringify(s),
      _1328: s => printToConsole(s),
      _1329: (o, p, r) => o.replaceAll(p, () => r),
      _1331: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1332: s => s.toUpperCase(),
      _1333: s => s.trim(),
      _1334: s => s.trimLeft(),
      _1335: s => s.trimRight(),
      _1336: (string, times) => string.repeat(times),
      _1337: Function.prototype.call.bind(String.prototype.indexOf),
      _1338: (s, p, i) => s.lastIndexOf(p, i),
      _1339: (string, token) => string.split(token),
      _1340: Object.is,
      _1341: o => o instanceof Array,
      _1342: (a, i) => a.push(i),
      _1346: a => a.pop(),
      _1347: (a, i) => a.splice(i, 1),
      _1348: (a, s) => a.join(s),
      _1349: (a, s, e) => a.slice(s, e),
      _1351: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1352: a => a.length,
      _1354: (a, i) => a[i],
      _1355: (a, i, v) => a[i] = v,
      _1357: o => {
      ...
      _1358: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1360: o => o instanceof Uint8Array,
      _1361: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1362: o => o instanceof Int8Array,
      _1363: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1364: o => o instanceof Uint8ClampedArray,
      _1365: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1366: o => o instanceof Uint16Array,
      _1367: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1368: o => o instanceof Int16Array,
      _1369: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1370: o => o instanceof Uint32Array,
      _1371: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1372: o => o instanceof Int32Array,
      _1373: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1375: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1376: o => o instanceof Float32Array,
      _1377: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1378: o => o instanceof Float64Array,
      _1379: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1380: (t, s) => t.set(s),
      _1382: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1384: o => o.buffer,
      _1385: o => o.byteOffset,
      _1386: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1387: (b, o) => new DataView(b, o),
      _1388: (b, o, l) => new DataView(b, o, l),
      _1389: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1390: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1391: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1392: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1393: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1394: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1395: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1396: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1397: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1398: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1399: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1400: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1403: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1404: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1405: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1406: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1407: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1408: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1421: (ms, c) =>
      ...
      _1426: () => Date.now(),
      _1431: o => Object.keys(o),
      _1432: (x0,x1) => new WebSocket(x0,x1),
      _1433: (x0,x1) => x0.send(x1),
      _1434: (x0,x1,x2) => x0.close(x1,x2),
      _1435: (x0,x1) => x0.close(x1),
      _1436: x0 => x0.close(),
      _1437: () => new AbortController(),
      _1438: x0 => x0.abort(),
      _1439: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1440: (x0,x1) => globalThis.fetch(x0,x1),
      _1441: (x0,x1) => x0.get(x1),
      _1442: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1442(f,arguments.length,x0,x1,x2) }),
      _1443: (x0,x1) => x0.forEach(x1),
      _1444: x0 => x0.getReader(),
      _1445: x0 => x0.read(),
      _1446: x0 => x0.cancel(),
      _1447: x0 => new BroadcastChannel(x0),
      _1448: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1448(f,arguments.length,x0) }),
      _1449: (x0,x1) => x0.postMessage(x1),
      _1450: x0 => x0.close(),
      ...
      _1549: () => globalThis.document,
      _1550: () => globalThis.window,
      _1555: (x0,x1) => { x0.height = x1 },
      _1557: (x0,x1) => { x0.width = x1 },
      _1560: x0 => x0.head,
      _1561: x0 => x0.classList,
      _1565: (x0,x1) => { x0.innerText = x1 },
      _1566: x0 => x0.style,
      _1568: x0 => x0.sheet,
      _1579: x0 => x0.offsetX,
      _1580: x0 => x0.offsetY,
      _1581: x0 => x0.button,
      _2959: (x0,x1) => { x0.src = x1 },
      _2961: (x0,x1) => { x0.type = x1 },
      _2967: (x0,x1) => { x0.defer = x1 },
      _3428: () => globalThis.window,
      _3471: x0 => x0.location,
      _3490: x0 => x0.navigator,
      _3754: x0 => x0.localStorage,
      _3762: x0 => x0.href,
      _3879: x0 => x0.userAgent,
      _3930: x0 => x0.data,
      _3977: (x0,x1) => { x0.onmessage = x1 },
      _4084: x0 => x0.length,
      _4301: x0 => x0.readyState,
      _4314: (x0,x1) => { x0.binaryType = x1 },
      _4317: x0 => x0.code,
      _4318: x0 => x0.reason,
      _6026: x0 => x0.signal,
      _6100: () => globalThis.document,
      _6182: x0 => x0.body,
      _7861: x0 => x0.value,
      _7863: x0 => x0.done,
      _8565: x0 => x0.url,
      _8567: x0 => x0.status,
      _8569: x0 => x0.statusText,
      _8570: x0 => x0.headers,
      _8571: x0 => x0.body,
      _12199: x0 => x0.name,
